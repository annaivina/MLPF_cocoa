...
_DESCRIPTION = """
COCOA EDM4HEP dataset with jj with raw calorimeter hits.
...
class CocoaEdmjjHitsPf(tfds.core.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(CocoaEdmjjHitsPf, self).__init__(*args, **kwargs)
